...
import com.dongrami.tag.repository.support.TagRepositorySupport;
...
public interface TagRepository extends JpaRepository<TagEntity, Long>, TagRepositorySupport {
