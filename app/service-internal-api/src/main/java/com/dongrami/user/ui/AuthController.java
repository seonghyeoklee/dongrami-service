...
public class AuthController {
    ...
    public ResponseEntity<?> login(
        ...
        UserRefreshTokenEntity userRefreshToken = userRefreshTokenRepository.findByUserId(userId);
        if (userRefreshToken == null) {
            // 없는 경우 새로 등록
            userRefreshToken = new UserRefreshTokenEntity(userId, refreshToken.getToken());
    ...
    public ResponseEntity<?> refreshToken (HttpServletRequest request, HttpServletResponse response) {
        ...
        // userId refresh token 으로 DB 확인
        UserRefreshTokenEntity userRefreshToken = userRefreshTokenRepository.findByUserIdAndRefreshToken(userId, refreshToken);
        if (userRefreshToken == null) {
            return ResponseEntity.badRequest().build();
        }
